  ...
  return (
    <div className="screen">
      ...
      <p className="hud-hint">
        {locked ? 'WASD move · Shift sprint · Mouse look · Click shoot · RMB zoom · X shoulder · Space jump · C crouch · F3 colliders · Esc menu' : 'Click to play · Esc menu'}
      </p>
    </div>
  )
}
